...
export default class ContentScreen extends React.Component{
    ...
    constructor(props){
      ...
      componentDidMount(){
        return fetch(
          'http://192.168.56.1:8080/api-android/list-question.php'
        )
      ...
      _Ghidanh(){
        ...
        fetch('http://192.168.56.1:8080/api-android/insert-scores.php?name='+this.state.name+'&scores='+this.state.position * 5, {
          method: 'GET',
          headers: {
        ...
        // fetch(
        //   'http://192.168.1.86:8080/api-android/insert-scores.php'
        // )
        //   .then(response => response.json())
        //   .then(responseJson => {
        //     this.setState(
